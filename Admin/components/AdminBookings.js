function AdminBookings() {
  ...
  React.useEffect(() => {
    fetch("https://bracu-bus-portal.onrender.com/api/bookings")
      .then((res) => res.json())
      .then((data) => {
        setBookings(data);
        setLoading(false);
  ...
  const handleTogglePayment = async (booking) => {
    ...
    try {
      const res = await fetch(
        `https://bracu-bus-portal.onrender.com/api/bookings/${booking._id}/payment-status`,
        {
          method: "PATCH",
  ...
  return (
    <div className="content">
      ...
      {loading && (
        <p style={{ padding: "20px", color: "#888" }}>Loading bookings...</p>
      )}
                ...
                >
                  ...
                  <td style={{ padding: "10px 14px" }}>
                    <span
                      style={{
                        background:
                          b.payment_method === "cash" ? "#fff3e0" : "#e3f2fd",
                        color:
                          b.payment_method === "cash" ? "#e65100" : "#1565c0",
                        borderRadius: "8px",
                        padding: "2px 9px",
                        fontSize: "12px",
                        fontWeight: 600,
                  ...
                  <td style={{ padding: "10px 14px" }}>
                    <button
                      disabled={
                        updatingId === b._id || b.status === "cancelled"
                      }
                      onClick={() => handleTogglePayment(b)}
                      style={{
                        background:
                          b.payment_status === "paid" ? "#e8f5e9" : "#fff3e0",
                        color:
                          b.payment_status === "paid" ? "#2e7d32" : "#e65100",
                  ...
                  <td style={{ padding: "10px 14px" }}>
                    <span
                      style={{
                        background:
                          b.status === "confirmed" ? "#e8f5e9" : "#fce4ec",
