function ScheduleManager() {
  const API = "https://bracu-bus-portal.onrender.com/api";
  ...
  async function fetchAll() {
    ...
    try {
      ...
      const [schData, routeData] = await Promise.all([
        schRes.json(),
        routeRes.json(),
      ]);
              ...
              <tbody>
                {items.map((s, i) => (
                  ...
                  >
                    ...
                    <td style={styles.td}>
                      <span style={styles.timeBadge("pickup")}>
                        {s.first_pickup_time}
                      </span>
                    </td>
                    <td style={styles.td}>
                      <span style={styles.timeBadge("pickup")}>
                        {s.second_pickup_time}
                      </span>
                    </td>
                    <td style={styles.td}>
                      <span style={styles.timeBadge("depart")}>
                        {s.first_departure_time}
                      </span>
                    </td>
                    <td style={styles.td}>
                      <span style={styles.timeBadge("depart")}>
                        {s.second_departure_time}
                      </span>
                    </td>
                    <td style={styles.td}>
                ...
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({
                        ...prev,
                        first_pickup_time: e.target.value,
                      }))
                    }
                    style={styles.input}
                  />
                ...
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({
                        ...prev,
                        second_pickup_time: e.target.value,
                      }))
                    }
                    style={styles.input}
                  />
                ...
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({
                        ...prev,
                        first_departure_time: e.target.value,
                      }))
                    }
                    style={styles.input}
                  />
                ...
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({
                        ...prev,
                        second_departure_time: e.target.value,
                      }))
                    }
                    style={styles.input}
                  />
