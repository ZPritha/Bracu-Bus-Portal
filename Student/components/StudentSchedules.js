function StudentSchedules() {
  ...
  return (
    <div className="content">
        ...
        <div style={stStyles.emptyBox}>
          ...
          <div style={{ color: "#999", marginTop: 4, fontSize: 14 }}>
            {filterRoute
              ...
              : "The admin hasn't added any schedules yet."}
          </div>
        </div>
      )}
      ...
      {!loading &&
        !error &&
        Object.entries(grouped).map(([key, { name, num, items }]) => (
            ...
            <div style={{ padding: "8px 0" }}>
              ...
              {items.map((s, i) => (
                ...
                >
                  ...
                  <span style={{ flex: 1, textAlign: "center" }}>
                    <span style={stStyles.pickupBadge}>
                      {formatTime(s.first_pickup_time)}
                    </span>
                  </span>
                  <span style={{ flex: 1, textAlign: "center" }}>
                    <span style={stStyles.pickupBadge}>
                      {formatTime(s.second_pickup_time)}
                    </span>
                  </span>
                  <span style={{ flex: 1, textAlign: "center" }}>
                    <span style={stStyles.departBadge}>
                      {formatTime(s.first_departure_time)}
                    </span>
                  </span>
                  <span style={{ flex: 1, textAlign: "center" }}>
                    <span style={stStyles.departBadge}>
                      {formatTime(s.second_departure_time)}
                    </span>
                  </span>
                </div>
              ))}
