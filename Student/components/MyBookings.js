function MyBookings({ currentUser, setActive }) {
  ...
  React.useEffect(() => {
    fetch(
      `https://bracu-bus-portal.onrender.com/api/bookings/user/${currentUser.studentId}`,
    )
      .then((res) => res.json())
      .then((data) => {
        setBookings(data);
  ...
  async function handleCancelBooking(bookingId, plan) {
    ...
    try {
      const res = await fetch(
        `https://bracu-bus-portal.onrender.com/api/bookings/${bookingId}/cancel`,
        {
          method: "PATCH",
        },
      );
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    background:
                      b.status === "confirmed" ? "#e8fff0" : "#ffe8e8",
                ...
                <div>
                  ...
                  <span
                    style={{
                      ...
                      marginLeft: "6px",
                      color:
                        b.arrival_status === "arrived" ? "#00884a" : "#ff9800",
                    }}
                  >
